			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="btn-group btn-group-justified" role="group"
					...
					<ul class="btn-group" role="group">
						<li class="btn btn-default"><a  href="03_IDKP0_00_DT.jsp" style="text-decoration:none;">动态规划法</a></li>
					</ul>
					<ul class="btn-group" role="group">
						<li class="btn btn-default"><a  href="03_IDKP0_00_HS.jsp" style="text-decoration:none;">回溯法</a></li>
					</ul>
					<ul class="btn-group" role="group">
						<li  class="btn btn-default"><a  href="03_IDKP0_00_YC.jsp" style="text-decoration:none;">遗传算法</a></li>
					</ul>
				</div>
				
				<h2 class="sub-header">idkp1-10/IDKP0/动态规划求最优解结果</h2>
